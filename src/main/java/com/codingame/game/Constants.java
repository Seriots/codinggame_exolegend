...
public class Constants {
    ...
    public static final String[] ACTIONS = new String[] { MOVE_FORWARD_ACTION, MOVE_BACKWARD_ACTION, TURN_RIGHT_ACTION, TURN_LEFT_ACTION, NOTHING_ACTION, TAKE_ACTION, DROP_ACTION };
}
